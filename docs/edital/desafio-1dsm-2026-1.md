...
- **RF09:** O sistema deve emitir um certificado final contendo, no mínimo: nome completo, CPF, e-mail, data de emissão, e a média final (com discriminação das notas por nível, se desejável).
...
- **RF12 (opcional – extensão):** O sistema pode disponibilizar uma área administrativa para cadastro e manutenção das questões, níveis e imagens.
