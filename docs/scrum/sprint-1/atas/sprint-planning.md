...
| ------ | --------------------------------- | ------------------------------------ | --- |
| S1_T01 | Elaboração `README.md` / Kanban   | Gustavo, Gabriel                     | 2   |
| S1_T02 | Diagramas de Caso de Uso          | Marcello, Vinicius, Gustavo, Gabriel | 5   |
| S1_T03 | Diagramas de Classe               | Marcello, Gustavo, Gabriel           | 5   |
| S1_T04 | Diagramas de Sequência            | Marcello, Vinicius, Gustavo, Gabriel | 5   |
| S1_T05 | Modelo Conceitual do BD           | Marcello, Vinicius, Gabriel          | 3   |
| S1_T06 | Modelo Lógico do BD               | Marcello, Vinicius, Gustavo          | 3   |
| S1_T07 | Identidade Visual                 | Andrea, Henrique, Lucas              | 8   |
| S1_T08 | Prototipação da Aplicação (Figma) | Andrea, Henrique, Lucas              | 8   |

**Subtotal: 39 SP**

### US01 — Cadastro de Usuário

| S1_T09 | Estrutura do projeto HTML/CSS/JS | Andrea, Henrique, Lucas | 2 |
| S1_T10 | Página de cadastro (HTML + CSS) | Andrea, Henrique, Lucas | 2 |
| S1_T11 | Validação de formulário JS com CPF | Andrea, Henrique, Lucas | 2 |
| S1_T12 | Rota POST de cadastro | Marcello, Gustavo | 2 |
| S1_T13 | Criptografia de senha no cadastro (bcrypt) | Marcello, Gustavo | 2 |
| S1_T14 | Validar CPF único no backend | Vinicius, Gabriel | 2 |
| S1_T15 | Script de inicialização do BD (schema.sql) | Andrea, Gustavo | 2 |
| S1_T16 | Conectar API no frontend (fetch) | Henrique, Lucas | 2 |
| S1_T17 | Teste de fluxo completo de cadastro | Vinicius, Gabriel | 2 |

**Subtotal: 18 SP**

### US02 — Login

| S1_T18 | Página de login (HTML + CSS) | Andrea, Henrique, Lucas | 2 |
| S1_T19 | Rota POST de login | Marcello, Gustavo | 2 |
| S1_T20 | Buscar usuário no BD pelo CPF | Vinicius, Gabriel | 2 |
| S1_T21 | Verificar senha com hash | Andrea, Henrique, Lucas | 2 |
| S1_T22 | Armazenar JWT/Token no frontend | Marcello, Gustavo | 2 |
| S1_T23 | Middleware de autenticação e proteção de rotas | Vinicius, Gabriel | 2 |
| S1_T24 | Página inicial / Painel de Módulos | Andrea, Henrique, Lucas | 2 |
| S1_T25 | Conectar frontend de login à API | Marcello, Vinicius | 2 |
| S1_T26 | Teste de fluxo completo de login | Gustavo, Gabriel | 2 |
...
| --- | ----------------------------------------------------------------------------- | :-----------: | :-----: | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| R1  | Não entrega de US01 — cadastro indisponível ao final da sprint                |     Média     |  Alto   | Priorizar S1_T12–S1_T14 (back-end de cadastro); integração com front-end (S1_T16) pode ser adiada desde que a API esteja funcional e testada (S1_T17)  |
| R2  | Não entrega de US02 — login indisponível ao final da sprint                   |     Média     |  Alto   | Priorizar S1_T19–S1_T23 (back-end de login); conexão com front-end (S1_T25) pode ser adiada desde que o fluxo de autenticação esteja validado (S1_T26) |
...
| --- | :------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------ | :----------------------------------: | :----------------------: |
| D1  |    🔴 Dura     | S1_T05 + S1_T06 (Modelos Conceitual e Lógico do BD) devem estar finalizados antes da criação do schema.sql                                                         | S1_T15                                                 | Marcello, Vinicius, Gustavo, Gabriel |    Dias 1–2 da sprint    |
| D2  |    🔴 Dura     | S1_T15 (schema.sql) deve estar concluído antes de qualquer implementação de back-end                                                                               | S1_T12, S1_T13, S1_T14, S1_T19, S1_T20, S1_T22, S1_T23 |           Andrea, Gustavo            |     Dia 3 da sprint      |
| D3  | 🟡 Recomendada | S1_T03 (Diagrama de Classe) deve estar revisado antes da implementação das entidades e rotas do back-end — garante consistência entre o modelo acordado e o código | S1_T12, S1_T13, S1_T14, S1_T19, S1_T20                 |      Marcello, Gustavo, Gabriel      | Antes de S1_T12 e S1_T19 |
...
| 2   | **Distribuição de tarefas por perfil:** o grupo DOC (S1_T01–S1_T08) foi composto por membros com maior afinidade com modelagem e design, enquanto as USs foram desenvolvidas em pares mistos para nivelar conhecimento técnico entre os membros.                                       |     |
